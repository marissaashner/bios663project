...
Based on the exploratory data an analysis plots, we decided to remove the variable "guardian" from our dataset since it didn't seem to have any influence on the outcome. 
