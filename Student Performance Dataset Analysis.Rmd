...
There are 30 inital covariates in the dataset. They are listed below with their in depth descriptions in the Appendix.
...
In order to determine the validity of all models, we must test the assumptions of linear regression. These include homogeneity of variances and gaussian errors. All assumptions are met in all models explored, and more detailed plots and tests for these assumptions can be seen in the appendix. 
