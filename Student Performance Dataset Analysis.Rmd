...
In order to determine the validity of all models, we must test the assumptions of linear regression. These include homogeneity of variances, linearity, and and gaussian errors. All assumptions are met in all models explored and more detailed plots and tests for these assumptions can be seen in the appendix.
...
Of all possible interaction pairs, several were significant. Among those, the most "interpretable" are studytime:schoolsupyes, studytime:famsupyes, studytime:goout, and schoolsupyes:goout. Interestingly, it appears that the effects of studytime are reduced for high values of goout; this may suggest that going out increases fatigue or distractedness, leading to a decreased benefit from studying. 
