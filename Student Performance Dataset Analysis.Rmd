...
Adjusted $R^2$ value for this model is `r summary(modelback)$adj.r.sq`. 
...
Adjusted $R^2$ value for this model is `r summary(model.int)$adj.r.sq`. 
...
Adjusted $R^2$ value for this model is `r summary(modelsmall)$adj.r.sq`. 
...
Adjusted $R^2$ value for this model is `r summary(smallint)$adj.r.sq`. 
...
Adjusted $R^2$ value for this model is `r summary(model6_all)$adj.r.sq`. 
